...
static const int64 nTargetTimespan = 3; // SmallChange: 0.35 days
static const int64 nTargetSpacing = 1 * 24 * 60 * 60; // SmallChange: 15 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "1496751518";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
